...
let table1 = document.getElementById("formTableBody");
let requestType = "";
const formTableBody = document.querySelector('#formTableBody tbody');
...
function createRow() {
    ...
    data += `</tr>`;
    formTableBody.innerHTML += data;
    GetSetRowInput("set");
} 

function itemCodeListener() {
    var table = $('#formTableBody');
